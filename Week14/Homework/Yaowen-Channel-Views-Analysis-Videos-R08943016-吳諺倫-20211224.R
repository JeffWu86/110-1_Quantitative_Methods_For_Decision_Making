...
plot2 <- ggplot(viewstat_stack, aes(fill=diffDate, y=Diff, x=title_name)) + 
  geom_bar(position="dodge", stat="identity") +
  coord_flip() + 
  labs(x='Name', y='viewCountDifference', title='YaoWenChannelStatsPlot2')
plot2

plot3 <- ggplot(viewstat_stack, aes(fill=diffDate, y=Diff, x=title_name)) + 
  geom_bar(position="stack", stat="identity") +
  coord_flip() + 
  labs(x='Name', y='viewCountDifference', title='YaoWenChannelStatsPlot3')
plot3
